...
const safety = {
  en: "HealthMatchAI does not diagnose, prescribe, treat, or replace professional medical care. For severe symptoms such as chest pain, trouble breathing, confusion, severe dehydration, or other emergency signs, seek urgent medical help.",
...
export const copy = {
  en: {
    ...
    home: {
      ...
      symptomTitle: "Start with what you feel",
      symptomDescription: "Choose common symptoms or describe your own. The result helps you think through risk level, possible causes, and care options.",
      ...
      careTitle: "Choose the right care setting",
      careDescription: "Compare common care routes before you spend time or money in the wrong place.",
      prepTitle: "Prepare a clearer clinician conversation",
