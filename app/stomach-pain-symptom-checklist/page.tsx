  ...
  return (
    <section className="app-page landing-page">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: "{\"@context\": \"https://schema.org\", \"@type\": \"FAQPage\", \"mainEntity\": [{\"@type\": \"Question\", \"name\": \"How do I know if abdominal pain is appendicitis?\", \"acceptedAnswer\": {\"@type\": \"Answer\", \"text\": \"Appendicitis typically starts with pain around the belly button that migrates to the lower right abdomen over several hours. The pain worsens with movement, coughing, or pressing on the area. It is often accompanied by loss of appetite, nausea, vomiting, and low-grade fever. If you suspect appendicitis, seek emergency care immediately. Only a clinician can confirm the diagnosis, usually with imaging.\"}}, {\"@type\": \"Question\", \"name\": \"Can stress cause stomach pain?\", \"acceptedAnswer\": {\"@type\": \"Answer\", \"text\": \"Yes. The gut and brain are closely connected through the gut-brain axis. Stress and anxiety can cause a range of gastrointestinal symptoms, including stomach cramps, nausea, diarrhea, and constipation. However, you should not assume stress is the cause without ruling out other possibilities with your clinician, especially if the pain is severe or persistent.\"}}, {\"@type\": \"Question\", \"name\": \"What does it mean if my stool is black?\", \"acceptedAnswer\": {\"@type\": \"Answer\", \"text\": \"Black, tarry stool (melena) can indicate bleeding in the upper gastrointestinal tract, such as from a stomach ulcer. This is a serious finding that warrants prompt medical evaluation. However, certain foods (like black licorice) and supplements (like iron or bismuth-containing medications) can also darken stool. A clinician can help distinguish between these possibilities.\"}}, {\"@type\": \"Question\", \"name\": \"Is it safe to take pain relievers for stomach pain?\", \"acceptedAnswer\": {\"@type\": \"Answer\", \"text\": \"Not always. Some over-the-counter pain relievers, particularly nonsteroidal anti-inflammatory drugs (NSAIDs) like ibuprofen or naproxen, can irritate the stomach lining and worsen certain conditions. Acetaminophen may be safer for some types of abdominal pain but does not reduce inflammation. Ask your clinician or pharmacist before taking any medication for undiagnosed abdominal pain.\"}}, {\"@type\": \"Question\", \"name\": \"Can HealthMatchAI tell me if my stomach pain is from something I ate?\", \"acceptedAnswer\": {\"@type\": \"Answer\", \"text\": \"No. HealthMatchAI cannot determine the cause of abdominal pain. Foodborne illness, indigestion, gastritis, ulcers, gallbladder disease, and many other conditions can cause similar symptoms. Use the tool to organize your information, then consult a licensed clinician who can perform an exam and order tests if needed.\"}}]}" }}
      />
    </section>
  );
}
