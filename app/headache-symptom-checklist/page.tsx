  ...
  return (
    <section className="app-page landing-page">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: "{\"@context\": \"https://schema.org\", \"@type\": \"FAQPage\", \"mainEntity\": [{\"@type\": \"Question\", \"name\": \"What is a thunderclap headache and why is it an emergency?\", \"acceptedAnswer\": {\"@type\": \"Answer\", \"text\": \"A thunderclap headache is a sudden, extremely severe headache that reaches maximum intensity within 60 seconds. It can be a sign of a life-threatening condition such as a ruptured aneurysm (subarachnoid hemorrhage), arterial tear, or blood clot. Anyone experiencing a thunderclap headache should go to the emergency department immediately.\"}}, {\"@type\": \"Question\", \"name\": \"How is a migraine different from a regular headache?\", \"acceptedAnswer\": {\"@type\": \"Answer\", \"text\": \"Migraines are a neurological condition, not just a bad headache. They typically involve throbbing pain, often on one side, and are accompanied by symptoms like nausea, vomiting, and extreme sensitivity to light and sound. Migraines can last hours to days and often interfere significantly with daily life. Many people with migraine also experience warning symptoms called aura before the pain starts.\"}}, {\"@type\": \"Question\", \"name\": \"Can dehydration cause a headache?\", \"acceptedAnswer\": {\"@type\": \"Answer\", \"text\": \"Yes. Dehydration is a common headache trigger. When your body loses more fluid than it takes in, the brain can temporarily shrink from fluid loss, pulling on the membranes that connect it to the skull and causing pain. Drinking water steadily throughout the day can help prevent dehydration-related headaches.\"}}, {\"@type\": \"Question\", \"name\": \"When should I see a neurologist for headaches?\", \"acceptedAnswer\": {\"@type\": \"Answer\", \"text\": \"Consider seeing a neurologist if your headaches are frequent (more than a few times per month), severe enough to interfere with your life, not responding to over-the-counter treatments, or changing in pattern or intensity. Your primary care provider can help you decide if a specialist referral is appropriate.\"}}, {\"@type\": \"Question\", \"name\": \"Can HealthMatchAI tell me if my headache is serious?\", \"acceptedAnswer\": {\"@type\": \"Answer\", \"text\": \"No. HealthMatchAI cannot determine the cause or seriousness of a headache. It helps you organize information about your symptoms and will flag red-flag items for your awareness, but only a licensed clinician can assess you in person, order imaging if needed, and make a diagnosis.\"}}]}" }}
      />
    </section>
  );
}
