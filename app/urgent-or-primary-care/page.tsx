  ...
  return (
    <section className="app-page landing-page">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: "{\"@context\": \"https://schema.org\", \"@type\": \"FAQPage\", \"mainEntity\": [{\"@type\": \"Question\", \"name\": \"Can I go to urgent care if I don't have insurance?\", \"acceptedAnswer\": {\"@type\": \"Answer\", \"text\": \"Yes. Urgent care centers treat patients regardless of insurance status. Many offer self-pay rates that are published in advance. It is a good idea to call ahead and ask about the estimated cost for an uninsured visit. HealthMatchAI's insurance guidance section also provides questions to ask before you go.\"}}, {\"@type\": \"Question\", \"name\": \"Will urgent care send records to my primary care doctor?\", \"acceptedAnswer\": {\"@type\": \"Answer\", \"text\": \"Many urgent care centers can forward a visit summary to your primary care provider with your permission. Ask the front-desk staff or provider to send the records, and provide your PCP's name and office contact information. It is also wise to bring a copy of your HealthMatchAI summary so you can share it yourself.\"}}, {\"@type\": \"Question\", \"name\": \"Can urgent care prescribe medication?\", \"acceptedAnswer\": {\"@type\": \"Answer\", \"text\": \"Yes. Urgent care providers can prescribe medications for acute conditions. However, they are unlikely to prescribe long-term controlled substances or manage complex chronic medication regimens. Those are better handled by a primary care provider or specialist who knows your full history.\"}}, {\"@type\": \"Question\", \"name\": \"Is a telehealth visit a third option?\", \"acceptedAnswer\": {\"@type\": \"Answer\", \"text\": \"Yes. Many primary care practices and standalone telehealth companies now offer virtual visits for certain conditions. Telehealth can be a good middle ground when you need timely advice but do not require a physical exam. HealthMatchAI's doctor-ready summary is especially helpful for telehealth visits.\"}}, {\"@type\": \"Question\", \"name\": \"What if I go to urgent care and they send me to the ER?\", \"acceptedAnswer\": {\"@type\": \"Answer\", \"text\": \"This happens when the urgent care provider determines your condition is more serious than their facility can handle. If this occurs, follow their guidance. They may arrange transport or direct you to the nearest emergency department. Your HealthMatchAI summary can help you communicate what has already been evaluated.\"}}]}" }}
      />
    </section>
  );
}
